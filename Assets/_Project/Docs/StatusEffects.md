...
메커니즘:
- 피격 시 받는 데미지를 철갑 수치만큼 감소
- 철갑은 소모되지 않음
- 턴이 지나도 유지됨 (영구)
- 예시:
  - 철갑 10, 공격 25 → 실제 피해 15 (25-10)
  - 철갑 10, 공격 8 → 실제 피해 0 (8-10, 최소 0)
  - 철갑 10은 유지됨

제거:
- 자연적으로 사라지지 않음
- 특수 효과(철갑 감소, 디스펠 등)로만 제거 가능
- MVP에서는 철갑 제거 메커니즘 없음

비교:
- Slay the Spire의 "Plated Armor" (턴마다 고정 방어력 제공)
